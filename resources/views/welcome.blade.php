...
<!-- Mirrored from templates.envytheme.com/vizo/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Sep 2020 02:37:59 GMT -->
<head>
        <!-- Required meta tags -->
        <meta charset="utf-8">
        <base href="{{ asset('public') }}/"><!--map all link-->
		...
		<title>Vizo - Restaurant and Cafe HTML Template</title>
    ...
    <body>
        ...
        <!-- End Navbar Area -->
        <!--Content-->
            @yield('content') <!--Load subpage here-->
        <!--Content-->
        <!-- Start Footer Area -->
                        ...
                        <div class="single-footer-widget">
                            ...
                            <ul class="footer-contact-info">
                                ...
                                <li>
                                    ...
                                    <span>Email</span>
                                    <a href="mailto:hello@vizo.com">hello@vizo.com</a>
                                </li>
                                <li>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-6">
                            <p>
                                ...
                                Copyright @2020 Vizo. All Rights Reserved by
...
<!-- Mirrored from templates.envytheme.com/vizo/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Sep 2020 02:38:15 GMT -->
</html>