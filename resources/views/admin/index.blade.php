...
<!-- Mirrored from www.bootstrapdash.com/demo/star-admin-pro/src/demo_2/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Oct 2020 11:56:26 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
          <a class="navbar-brand brand-logo" href="{{route('blank')}}">
            <img src="https://www.bootstrapdash.com/demo/star-admin-pro/src/assets/images/logo_11.svg" alt="logo" /> </a>
          <a class="navbar-brand brand-logo-mini" href="{{route('blank')}}">
            <img src="https://www.bootstrapdash.com/demo/star-admin-pro/src/assets/images/logo-mini_11.svg" alt="logo" /> </a>
        </div>
        ...
        <div class="theme-setting-wrapper">
          <div id="theme-settings" class="settings-panel">
            ...
            <div class="demo-screen-wrapper">
              <a href="https://www.bootstrapdash.com/demo/star-admin-pro/src/demo_1/index.html" class="demo-thumb-image">
                <img src="assets/images/screenshots/default.jpg" alt="demo image">
              </a>
              <a href="{{route('blank')}}" class="demo-thumb-image">
                <img src="assets/images/screenshots/default-two.jpg" alt="demo image">
              </a>
              <a href="https://www.bootstrapdash.com/demo/star-admin-pro/src/demo_3/index.html" class="demo-thumb-image">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#resources-dropdown" aria-expanded="false" aria-controls="resources-dropdown">
                ...
                <span class="menu-title">Resouces</span>
                <i class="menu-arrow"></i>
              </a>
              <div class="collapse" id="resources-dropdown">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{route('blank')}}">Finance</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{route('blank')}}">Orders</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{route('blank')}}">Delivery</a>
                  </li>
                </ul>
              </div>
            </li>
