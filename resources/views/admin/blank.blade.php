...
<!-- Mirrored from www.bootstrapdash.com/demo/star-admin-pro/src/demo_2/blank-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Oct 2020 11:56:26 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <div class="theme-setting-wrapper">
          <div id="theme-settings" class="settings-panel">
            ...
            <div class="demo-screen-wrapper">
              ...
              <a href="index.html" class="demo-thumb-image">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="resources-dropdown">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="blank-page.html">Finance</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="blank-page.html">Orders</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="blank-page.html">Delivery</a>
                  </li>
                </ul>
              </div>
            </li>
